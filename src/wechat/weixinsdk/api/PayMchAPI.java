...
import wechat.weixinsdk.bean.paymch.Closeorder;
import wechat.weixinsdk.bean.paymch.MchBaseResult;
import wechat.weixinsdk.bean.paymch.MchShorturl;
import wechat.weixinsdk.bean.paymch.MchShorturlResult;
import wechat.weixinsdk.bean.paymch.Refundquery;
import wechat.weixinsdk.bean.paymch.RefundqueryResult;
import wechat.weixinsdk.bean.paymch.SecapiPayRefund;
import wechat.weixinsdk.bean.paymch.SecapiPayRefundResult;
import wechat.weixinsdk.bean.paymch.Unifiedorder;
import wechat.weixinsdk.bean.paymch.UnifiedorderResult;
import wechat.weixinsdk.client.XmlResponseHandler;
import wechat.weixinsdk.util.MapUtil;
import wechat.weixinsdk.util.SignatureUtil;
